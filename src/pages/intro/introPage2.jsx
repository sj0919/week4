    ...
    <Layout>
      ...
      <ScrollingTextContainer>
        <Text>
          "왜 이런 걸 샀어? 이건 별로야." <br />
          알빠야? <br />
          "너는 왜 요즘 밤늦게까지 깨어 있어?" <br />
          알빠야?
          <br /> "왜 너는 항상 점심에 김밥만 먹어?" <br />
          알빠야? <br />
          "너 오늘 양말 왜 짝짝이로 신었어?"
          <br /> 알빠야? <br />
          "너는 왜 이렇게 늦게까지 공부해?" <br />
          알빠야? <br />
          "너는 왜 항상 카페에서 공부해?" <br />
          알빠야? <br />
          "왜 너는 매일 커피만 마셔?" <br />
          알빠야? <br />
          "왜 너는 항상 같은 티셔츠만 입어?" <br />
          알빠야? <br />
          "너는 왜 이렇게 혼자 다녀?" <br />
          알빠야? <br />
          "왜 너는 새로 산 신발을 안 신고 다녀?"
          <br /> 알빠야? <br />
          "너는 왜 시험 공부를 전날에만 해?" <br />
          알빠야? <br />
          "왜 넌 항상 이 시간에 밥을 먹어?" <br />
          알빠야? <br />
          "왜 너는 여행 가는 걸 별로 안 좋아해?" <br />
          알빠야? <br />
          "너는 왜 항상 노트북을 들고 다녀?" <br />
          알빠야? <br />
          "왜 너는 사진 찍을 때 항상 정면만 봐?" <br />
          알빠야?
        </Text>
      </ScrollingTextContainer>
      <StyledArrow
